...
export class WitnessTSA {
    constructor() {
        ...
        this.extractGenTimeFromResp = (resp) => {
            ...
            const tstInfoAsn1 = asn1js.fromBER(signedData.encapContentInfo.eContent.valueBlock.valueHexView);
        ...
        this.verify = async (transactionHash, expectedMR, expectedTimestamp) => {
            ...
            const messageImprintHash = Buffer.from(tstInfo.messageImprint.hashedMessage.valueBlock.valueHexView).toString("hex");
