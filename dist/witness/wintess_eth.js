...
export class WitnessEth {
    ...
    // CLI Witness Method
    static async witnessCli(walletPrivateKey, witnessEventVerificationHash, smartContractAddress, WitnessNetwork, providerUrl) {
        try {
    ...
    static async verify(WitnessNetwork, transactionHash, expectedMR, expectedTimestamp) {
