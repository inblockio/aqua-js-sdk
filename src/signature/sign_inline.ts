import { CredentialsData, LogData, InlineSignerOptions, ReactNativeMetaMaskOptions } from '../types';
 ...
 */
export class InlineSigner implements SignerStrategy {
    ...
    public async sign(targetRevisionHash: string, _credentials: CredentialsData, _reactNativeOptions?: ReactNativeMetaMaskOptions, inlineSignerOptions?: InlineSignerOptions): Promise<SignResult> {
